...
# benefits seeds
    ...
    benefits_list.each do |name, description|
      Benefit.create( name: "#{name}", description: "#{description}", listing_id: rand(1..5))
    end
...
# college major seeds
    ...
    college_majors_list.each do |name, description|
      CollegeMajor.create( name: "#{name}", description: "#{description}", listing_id: rand(1..5))
    end
...
# education level seed
    ...
    education_levels_list.each do |name, description|
      EducationLevel.create( name: "#{name}", description: "#{description}", listing_id: rand(1..5))
    end
...
# type of employment seeds
    ...
    type_of_employments_list.each do |name, description|
      TypeOfEmployment.create( name: "#{name}", description: "#{description}", listing_id: rand(1..5))
    end
